...
from Community.serializers import SubjectDetailSerializer, SubjectListSerializer, FavoriSerializer, MessageSerializer, KeyWordSerializer
from Community.models import Subject, Message, KeyWord, Favori
