...
EMAIL_HOST_PASSWORD = config("EMAIL_HOST_PASSWORD")#os.getenv("EMAIL_HOST_PASSWORD")
EMAIL_USE_TLS = True
...
#API Fixer :
FIXER_KEY = config("FIXER_KEY")#os.getenv("FIXER_KEY") 
#API ChatGpt :
