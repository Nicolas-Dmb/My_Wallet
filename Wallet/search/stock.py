...
class SearchRealEstate: 
    ...
    def get(cls,input:str, wallet:Wallet)-> Iterable[SearchModel]:
        ...
        return (cls._toSearchModel(stock) for stock in stocks)
    ...
    @classmethod
    def _isOwned(cls, stock:Asset)-> bool:
        return OwnedAsset.objects.filter(ticker=stock.ticker).exists()
    
    @classmethod
    def _toSearchModel(cls,stock:Asset)-> SearchModel:
        return SearchModel(
