...
from Wallet.models import Buy, Sells, Wallet, Asset, Cash, CashDetail, CryptoDetail, BourseDetail, RealEstateDetail, RealEstate, Categories, HistoricalPrice, Crypto, Bourse, Cash, HistoricalWallet, HistoricalBourse, HistoricalCrypto, HistoricalCash,  HistoricalImmo
