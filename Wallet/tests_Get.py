...
from Wallet.tests import BuyFixture,PostCash,PostSell,RealEstateDetailfixture,NewRealEstate,ModifRealEstate,buy,sell,modif,Newbuy,NewRealEstate,ModifRealEstate,NewCashDetail,ModifCashDetail
from Wallet.models import Asset, Buy, Sells, Wallet, CryptoDetail, BourseDetail, CashDetail, RealEstate, RealEstateDetail, HistoricalPrice, HistoricalWallet, HistoricalCrypto, HistoricalBourse, HistoricalCash, HistoricalImmo, Bourse, Crypto, Cash
import django
django.setup()
